  ...
  () => {
    ...
    const getInsumos = async () => {
      try {
        ...
        console.error("Error en la petición de Insumos", error.response || error);
        return error;
      }
    };
    ...
    const getSemillas = async () => {
      try {
        ...
        console.error("Error en la petición de Semillas", error.response || error);
        return error;
      }
    };

    const getProveedores= async () => {  // Función renombrada a getProveedor
      try {
        if (!useAdmin.token) {
          console.error("Token no encontrado");
          return;
        ...
        console.error("Error en la petición de Proveedores", error.response || error);
        return error;
      }
    };
    ...
    const getGastos = async () => {
      try {
        ...
        console.error("Error en la petición de Gastos", error.response || error);
        return error;
      }
    };
    ...
    const postGastos = async (datos) => {
      try {
        ...
        console.error("Error al crear el Gasto", error.response || error);
        return error;
      }
    };
    ...
    const putGastos = async (id, datos) => {
      try {
        ...
        console.error("Error al actualizar el Gasto", error.response || error);
        return error;
      }
    };
