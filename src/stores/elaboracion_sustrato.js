...
export const useStoreElaboracion_sustrato = defineStore("Elaboracion_sustrato", () => {
    ...
    const postElaboracion_sustrato = async (datos) => {
        try {
            const r = await axios.post(`${url}/Elaboracion_sustrato/`, datos, {
                    headers: {
                        token: useUsuario.token
                    }
                });
    ...
    const putElaboracion_sustrato = async (id, datos) => {
        try {
            const r = await axios.put(`${url}/Elaboracion_sustrato/${id}`, datos, {
                    headers: {
                        token: useUsuario.token
                    }
                });
