 <template>
  <q-layout view="hHh lpR fFf">
    ...
    <q-drawer :model-value="leftDrawerOpen" show-if-above side="left" overlay>
      <div class="drawer-links">
        <router-link lass="r" to="/Admin">Administrador</router-link>
        <router-link class="r" to="/AnalisisSuelo">Analisis de suelo</router-link>
        <router-link class="r" to="/Climas">Climas</router-link>
        <router-link class="r" to="/Comprador">Comprador</router-link>
        <router-link class="r" to="/ControlPlagas">Control de Plagas</router-link>
        <router-link class="r" to="/Cultivos">Cultivos</router-link>
        <router-link class="r" to="/ElaboracionSustrato">Elaboracion de Sustrato</router-link>
        <router-link class="r" to="/Empleados">Empleados</router-link>
        <router-link class="r" to="/Factura">Factura</router-link>
        <router-link class="r" to="/Fertilizacion">Fertilizacion</router-link>
        ...
        <router-link class="r" to="/Mantenimiento">Mantenimiento</router-link>
        <router-link class="r" to="/MaquinariaHerramientas">Maquinaria de herramientas</router-link>
        <router-link class="r" to="/Nomina">Nomina</router-link>
        <router-link class="r" to="/Parcelas">Parcelas</router-link>
        <router-link class="r" to="/Preparacion de suelos">Preparacion de suelos</router-link>
        <router-link class="r" to="/Procesos">Procesos</router-link>
        <router-link class="r" to="/Produccion">Produccion</router-link>
        <router-link class="r" to="/Proveedores">Proveedores</router-link>
